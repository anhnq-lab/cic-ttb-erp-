    ...
    if (contracts.length === 0) {
        return (
            <div className="text-center py-10 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                ...
                <button className="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-bold shadow hover:bg-indigo-700 transition-all">
                    Thêm hợp đồng
                </button>
            </div>
        );
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <button className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-indigo-700 transition-all flex items-center gap-2">
                                            ...
                                            {amendments[contract.id].map(am => (
                                                <div key={am.id} className="flex items-center justify-between p-3 bg-indigo-50 rounded-lg border border-indigo-100 hover:border-indigo-200 transition-colors">
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <p className="text-[10px] text-gray-500">Sau ĐC: {formatCurrency(am.newTotalValue)}</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
